...
- **[Explicit loading](https://docs.microsoft.com/en-us/ef/core/querying/related-data/explicit)** means that the related data is explicitly loaded from the database at a later time.
